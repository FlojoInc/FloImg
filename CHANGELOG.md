...
- fix: Add overlay/reference image injection to executePipeline
  - Fixes composite workflows failing with "Cannot read properties of undefined"
  - The /api/execute/stream endpoint now correctly injects overlay blobs
  - Also adds reference image injection for edit/inpaint transforms
